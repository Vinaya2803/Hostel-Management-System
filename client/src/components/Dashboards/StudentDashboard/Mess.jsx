...
function Mess() {
  let requestMessOff = async (event) => {
    ...
    let response = await fetch("https://hostel-management-system-oghr.onrender.com/api/Messoff/request", {
      method: "POST",
      headers: {
  ...
  useEffect(() => {
    ...
    setLoading(true);
    if (student) {
      fetch("https://hostel-management-system-oghr.onrender.com/api/Messoff/count", {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  return (
    ...
    <div className="w-full h-screen gap-5 flex flex-col items-center justify-center  pt-[500px] sm:pt-96 md:pt-96 lg:pt-40">
      ...
      <div className="w-full gap-10 flex items-center justify-center flex-wrap">
        <div className="w-full sm:w-80 max-w-md max-h-60 border rounded-lg shadow sm:p-8 bg-neutral-950 border-neutral-900 drop-shadow-xl overflow-y-auto">
