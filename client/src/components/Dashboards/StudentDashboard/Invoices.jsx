...
function Invoices() {
  ...
  return (
    <div className="w-full h-screen flex flex-col gap-3 items-center justify-center overflow-y-auto ">
      <h1 className="text-white font-bold text-5xl mt-20">Invoices</h1>
